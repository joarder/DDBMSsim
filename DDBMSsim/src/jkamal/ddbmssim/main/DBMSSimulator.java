...
public class DBMSSimulator {	
	...
	private static void runSimulation(Database db, Workload workload, WorkloadGenerator workloadGenerator, 
		...
		write("Total "+sampled_workload.getWrl_totalTransactions()+" transactions containing "+sampled_workload.getWrl_totalDataObjects()+" data tuples have been identified for partitioning.", "MSG");		
		//sampled_workload.show(db, "");
